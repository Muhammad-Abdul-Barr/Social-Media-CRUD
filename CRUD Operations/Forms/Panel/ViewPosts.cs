...
namespace CRUD_Operations.Forms.Panel
{
    public partial class ViewPosts : UserControl
    {
        ...
        private void ViewPosts_Load(object sender, EventArgs e)
        {
            ...
            string query = "EXEC stp_GetPosts @UserID=@uid;";
            ...
            guna2DataGridView1.Columns["PageID"].Visible = false;
        ...
        private void guna2GradientButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                Interact form = new Interact();
                Interact.postid = int.Parse(guna2DataGridView1.SelectedRows[0].Cells["PostID"].Value.ToString());
        ...
        private void guna2GradientButton1_Click(object sender, EventArgs e)
        {
            if (guna2DataGridView1.SelectedRows.Count > 0)
            {
                ...
                {
                    Reddit_EditPost form = new Reddit_EditPost();
                    Reddit_EditPost.postid = int.Parse(guna2DataGridView1.SelectedRows[0].Cells["PostID"].Value.ToString());
                ...
                if (LoggedInUser.UserID == OwnerID)
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            string query = "EXEC del_InteractionsByPostID @id = @Pageid;";
                            SqlCommand cmd3 = new SqlCommand(query, con);
                            cmd3.Parameters.AddWithValue("@Pageid", Pid);
                            cmd3.ExecuteNonQuery();

                            query = "EXEC del_FBPostByID @id = @Pageid;";
        ...
        private void guna2GradientButton4_Click(object sender, EventArgs e)
        {
            if (guna2DataGridView1.SelectedRows.Count > 0)
            {
                ViewInteractions form = new ViewInteractions();
                ViewInteractions.postid = int.Parse(guna2DataGridView1.SelectedRows[0].Cells["PostID"].Value.ToString());
                FB_Dashboard.pp.panel3.Controls.Clear();
                FB_Dashboard.pp.panel3.Controls.Add(form);
                FB_Dashboard.pp.Show();
            }
